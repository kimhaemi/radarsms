...
public class StationService {
    ...
    public List<ReceiveSettingDto> getReceiveSetting (String dataKind, Integer permitted_watch){
        //select * from receive_setting where permitted_watch = 1 and data_kind = #data_kind#
    ...
    //과거자료
    // public Map<String, ReceiveDataVO> getReceiveData(String kind, String site, List<ReceiveSettingVO> receiveSetting, Date now) {
    ...
    //         String key = String.valueOf(vo.getData_type()) + "#" + DateUtil.formatDate("yyyy.MM.dd_HH:mm", vo.getData_time());
    //         map.put(key, vo);
    //       } 
    //     } 
